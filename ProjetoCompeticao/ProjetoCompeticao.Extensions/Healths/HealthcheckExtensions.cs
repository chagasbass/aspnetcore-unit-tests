    ...
    public static class HealthcheckExtensions
    {
        ...
        public static IServiceCollection AddMapHealthChecksUi(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddHealthChecksUI(setupSettings: setup =>
                {
                    setup.SetHeaderText(healthcheckOptions.ApiName);
                    setup.SetEvaluationTimeInSeconds(healthcheckOptions.SetEvaluationTimeInSeconds);
                    setup.MaximumHistoryEntriesPerEndpoint(healthcheckOptions.MaximumHistoryEntriesPerEndpoint);
                }).AddInMemoryStorage();
            #endregion
